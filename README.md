...
# CUDA 11.6
pip install scButterfly-0.0.8-py3-none-any.whl --extra-index-url https://download.pytorch.org/whl/cu116

# CUDA 11.3
pip install scButterfly-0.0.8-py3-none-any.whl --extra-index-url https://download.pytorch.org/whl/cu113

# CUDA 10.2
pip install scButterfly-0.0.8-py3-none-any.whl --extra-index-url https://download.pytorch.org/whl/cu102

# CPU only
pip install scButterfly-0.0.8-py3-none-any.whl --extra-index-url https://download.pytorch.org/whl/cpu
```
